...
Desenvolver e avaliar tecnicamente uma arquitetura de aplicação web para anamnese assistida,
...
\item Desenvolver uma interface reativa para avaliação do protótipo funcional.
\item Especificar e executar testes exploratórios sobre comportamento conversacional, extração de
entidades e latência.
\item Avaliar a viabilidade técnica da solução por evidências qualitativas e artefatos de teste.
\end{itemize}
...
protótipo funcional. O Capítulo 5 apresenta as considerações finais desta etapa do projeto e o
cronograma da etapa subsequente.
