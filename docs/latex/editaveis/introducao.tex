...
\item Definir a metodologia de desenvolvimento do software e os artefatos de avaliação da proposta.
\item Projetar e implementar a camada de API integrada da aplicação para
orquestrar inferências, autenticação, persistência e geração de relatórios.
...
\item Desenvolver uma interface reativa e responsiva para utilização do sistema em ambiente web.
\item Especificar e executar testes exploratórios sobre comportamento conversacional, extração de
entidades e latência.
\item Avaliar tecnicamente a solução por evidências qualitativas e artefatos de teste.
\end{itemize}
